  ...
  return (
    <MainLayout>
      <div
        id="project"
        name="projects"
        className="w-full min-h-screen bg-[#111623] text-white pb-20 pt-40 lg:pt-20 overflow-hidden"
      >
        <div className="max-w-[1200px] w-full md:h-screen mx-auto px-5 md:px-10 flex flex-col justify-center">
